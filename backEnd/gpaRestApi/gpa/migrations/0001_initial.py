# Generated by Django 3.0.9 on 2020-09-14 21:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='animales', to='gpa.Animal')),
                ('persona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='personas', to='gpa.Persona')),
